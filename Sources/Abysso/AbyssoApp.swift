...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private static let removableMenuTitles: Set<String> = [
        "파일", "File", "ファイル", "檔案", "Ablage", "Datei", "Archivo", "Fichier",
        "포맷", "Format", "フォーマット", "格式", "Formato",
        "보기", "View", "表示", "顯示方式", "Darstellung", "Visualización", "Présentation",
        "도움말", "Help", "ヘルプ", "輔助說明", "Hilfe", "Ayuda", "Aide",
    ]
